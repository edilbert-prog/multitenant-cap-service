...
const DialogPortal = ({
  ...
  <DialogPrimitive.Portal {...props}>
    <div style={{ zIndex: 1020 }} className="nopan nodelete nodrag noflow fixed inset-0 z-50 flex items-center justify-center">
      {children}
    </div>
        ...
        >
          ...
          >
            <DialogPrimitive.Close
              className={cn(
                "absolute right-2 top-2 flex h-8 w-8 items-center justify-center rounded-sm ring-offset-white transition-opacity hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#0071E9] focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-gray-100 data-[state=open]:text-gray-500",
