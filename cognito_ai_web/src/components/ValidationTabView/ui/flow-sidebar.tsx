      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex h-full w-full text-gray-900 has-[[data-variant=inset]]:bg-white",
              className,
            )}
            data-open={open}
            ref={ref}
      ...
      return (
        ...
        >
          <div
            ...
            className={cn(
              "group flex h-full w-[--sidebar-width] flex-col bg-white text-gray-900 group-data-[side=left]:border-r group-data-[side=right]:border-l",
              className,
            )}
          >
            {children}
      ...
      >
        ...
        <div
          className={cn(
            ...
            collapsible === "icon"
              ? "max-sm:w-[var(--sidebar-width-icon)]"
              : "max-sm:w-0",
          )}
        />
        <div
          className={cn(
            ...
            "w-[var(--sidebar-width)]",
            "max-sm:group-data-[state=collapsed]:w-[var(--sidebar-width-icon)]",
            side === "left"
