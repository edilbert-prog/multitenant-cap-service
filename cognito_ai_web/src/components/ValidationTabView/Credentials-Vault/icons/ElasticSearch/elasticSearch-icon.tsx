...
export const ElasticSearchIcon = ({ className, color = "currentColor", ...props }) => ( //
  <svg
    width="40"
    height="40"
    viewBox="0 0 32 32"
