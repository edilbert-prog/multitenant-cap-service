 ...
 */
    ...
    const columns: { title: string; key: string; className?: string }[] = [
        { title: "Key Mapping Details", key: "MainInfo", className: "min-w-[700px]" },
    ];

    const allRows: TestCaseKey[] = [...state.newRows, ...state.testCaseKeys];

    // TestCaseKeysTab.tsx - Modified data rendering
        ...
        return {
            MainInfo: (
                <div className="space-y-3 w-full">
                    ...
                    <div className="border-t border-gray-200 pt-3">
                        <p className="text-sm font-semibold text-gray-700 mb-3">Component Details</p>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="text-xs font-medium text-gray-700 mb-1 block">
                    ...
                    {/* Source Component Section - Collapsible */}
                    <details className="border-t border-gray-200 pt-3">
                        <summary className="text-sm font-semibold text-gray-700 mb-3 cursor-pointer hover:text-blue-600 flex items-center">
                            <span>Source Component (Optional)</span>
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-3">
                            ...
                            <div>
                                <label className="text-xs font-medium text-gray-700 mb-1 block">Source Component</label>
                                <Dropdown
                                    size="small"
                                    mode="single"
                                    searchable={true}
                            ...
                            <div>
                                <label className="text-xs font-medium text-gray-700 mb-1 block">Source Key Type</label>
                                <Dropdown
                                    size="small"
                                    mode="single"
                                    searchable={false}
                            ...
                            <div>
                                <label className="text-xs font-medium text-gray-700 mb-1 block">Source Key Name</label>
                                <input
                                    type="text"
            ...
            actions: (
                <div className="relative flex items-center justify-end">
                    ...
                    >
                        <button className="pr-4 flex items-center hover:bg-red-50 p-2 rounded">
    ...
    // View mode - Simplified card view
    return {
        MainInfo: (
            <div className="space-y-3 py-2 w-full">
                ...
                <div className="border-t border-gray-200 pt-3">
                    <p className="text-xs font-semibold text-gray-600 mb-2">Component Details</p>
                ...
                {(item.SourceComponentType || item.SourceComponent) && (
                    <details className="border-t border-gray-200 pt-3">
                        <summary className="text-xs font-semibold text-gray-600 cursor-pointer hover:text-blue-600 flex items-center">
                            <span>Source Component Details</span>
                            <svg className="w-3 h-3 ml-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                            </svg>
                        </summary>
