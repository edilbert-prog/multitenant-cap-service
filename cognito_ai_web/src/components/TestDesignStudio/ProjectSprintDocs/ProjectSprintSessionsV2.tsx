// /mnt/data/ProjectSprintSessionsV2
...
export default function ProjectSprintSessionsV2(props: Props) {
    ...
    const getData = async (SearchQuery: string = "", SourceType: string = ""): Promise<void> => {
        try {
            const resp: any = await apiRequest("/client-project-sessions/GetProjectSprintSessions", {
                StartDate: "",
                EndDate: "",
                SourceType,
            ...
            if (resp.ResponseData.length > 0) {
                ...
                resp.ResponseData.forEach((v: any) => {
                    finalSessionList.push({
                        ...
                        BusinessProcessId: props.CurrentSprint.BusinessProcessId as string | undefined,
                        ClientId: v.ClientId,
